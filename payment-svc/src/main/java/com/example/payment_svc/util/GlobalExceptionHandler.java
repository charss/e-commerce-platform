package com.example.payment_svc.util;

import com.example.payment_svc.exception.*;
...
public class GlobalExceptionHandler {
    ...
    public @ResponseBody ErrorResponse handlePaymentNotFound(PaymentNotFoundException ex) {
        return new ErrorResponse(HttpStatus.NOT_FOUND.value(), ex.getMessage());
    }

    @ExceptionHandler(PaymentMethodRequiredException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public @ResponseBody ErrorResponse handlePaymentMethodRequired(PaymentNotFoundException ex) {
        return new ErrorResponse(HttpStatus.BAD_REQUEST.value(), ex.getMessage());
    }

    @ExceptionHandler(CardDeclinedException.class)
    @ResponseStatus(HttpStatus.PAYMENT_REQUIRED)
    public @ResponseBody ErrorResponse handleCardDeclined(CardDeclinedException ex) {
