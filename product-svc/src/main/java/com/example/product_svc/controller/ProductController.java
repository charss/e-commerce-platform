...
public class ProductController {
    ...
    public ResponseEntity<List<ProductVariantResponseDto>> getAllProductVariants(@PathVariable(value = "id") UUID id) {
        List<ProductVariantResponseDto> products = productService.getAllVariantsByProduct(id);
        return ResponseEntity.ok(products);
    }
